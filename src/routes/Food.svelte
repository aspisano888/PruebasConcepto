<script>
  ...
  <Footer footerType="socialmedia" class="bg-teal-600 ">
    <div class="md:flex md:justify-between ">
      ...
      <div class="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
        <div>
          ...
          <FooterLinkGroup class="text-slate-300">
        ...
        <div>
          <h2 class="mb-6 text-sm font-semibold uppercase text-gray-900 dark:text-white">us</h2>
          <FooterLinkGroup class="text-slate-300">
            <FooterLink liClass="mb-4" href="/about">About</FooterLink>
            <FooterLink liClass="mb-4" href="/contacto">Contacto</FooterLink>
          </FooterLinkGroup>
        </div>
        <div>
